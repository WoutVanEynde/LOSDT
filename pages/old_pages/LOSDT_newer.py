    ...
    with tab1:
        ...
        if radial_dir.exists():
            ...
            if plot_files:
                ...
                display_df['protonated_structure_image'] = display_df['Protonated SMILES'].apply(smiles_to_base64)
                ...
                st.dataframe(display_df.style.map(color_lipinski, subset=['Lipinski']), column_config={'structure_image': st.column_config.ImageColumn("Structure",width="medium", pinned=True),
                                                'protonated_structure_image': st.column_config.ImageColumn("Protonated SMILES", width="medium", pinned=True),
