...
def predict_admet_properties(smiles: str, output_csv_path: Path, protonation: bool) -> None:
...
def run_molecular_pipeline(smiles_string: str, 
    ...
    if pdb_file_path:
        ...
        if protonation is True:
            align_molecules(ligand_sdf, aligned_dir, results_csv_path, "Protonated SMILES")
        else:
        ...
        if energy_minimization is True:
            zip_files([ligand_sdf, aligned_dir, complexes_dir, em_complexes_dir], zip_path)
        else:
